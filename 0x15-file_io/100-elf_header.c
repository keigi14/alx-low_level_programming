 ...
 * @e_ident: A ptr to an array containing the ELF magic nubr.
...
/**
 * print_magic - Print the magic nubrs of an ELF header.
 * @e_ident: A ptr to an array containing the ELF magic nubr.
 * Description: Magic nubrs are separated by space.
 */
...
/**
 * print_version - Print de version of an ELF header.
 ...
 * @argc: The nubr of arguments supplied to the program.
